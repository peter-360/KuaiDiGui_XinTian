...
u8 key_mode =1;
 ...
 {	
	...
	//TIM4 led
	TIM4_Int_Init(2999,7199);//10KhzµÄ¼ÆÊýÆµÂÊ£¬¼ÆÊýµ½10000Îª1s  
	TIM4_Set(0);			//¶¨Ê±Æ÷4
    ...
    if(status != KEY_NoPress)
    {
      if(status == KEY_ShortPress)
      {
        ...
        key2ShortPressCount++;
				if(0== mode_nomal)
				{
//					TIM4_Int_Init(999,7199);//10KhzµÄ¼ÆÊýÆµÂÊ£¬¼ÆÊýµ½1000Îª100ms  
//					TIM4_Set(1);
					key_mode = 2;
					mode_nomal =1;
